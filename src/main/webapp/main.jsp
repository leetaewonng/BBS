...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse id=bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="https://ncvr.kdca.go.kr/">예약하러
						가기</a></li>
			...
			<div class="container">
				...
				<p>
					...
					<a class="btn btn-primary btn-pull"
						href="https://ncvr.kdca.go.kr/cobk/index_n.html" role="button">예약하러가기</a>
				</p>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row">
	<div
		style="background-color: #eeeeee; float: left; width: 33%; text-align: center;">
		<h>백신 접종 전</h>
		<br>
		<h>주의사항</h>
		<br> <a class="btn btn-primary btn-pull" href="vaccineB.jsp"
			role="button">자세히</a>
	</div>
	<div
		style="background-color: #eeeeee; float: left; width: 33%; text-align: center;">
		...
		<br>
		<h>주의사항</h>
		<br> <a class="btn btn-primary btn-pull" href="vaccineA.jsp"
			role="button">자세히</a>
	</div>
	<div
		style="background-color: #eeeeee; float: left; width: 33%; text-align: center;">
		...
		<br>
		<h>게시판</h>
		<br> <a class="btn btn-primary btn-pull" href="bbs.jsp"
			role="button">바로가기</a>
	</div>
	</div>
	</div>
	<footer class="bg-dark mt-4 p-5 text-cexter" style="color: #FFFFFF;">
		Copyright &copy; 웹 프로그램개발 21이태웅
		</footer>
