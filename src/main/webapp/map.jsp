...
<body>
	...
	<script>
		...
		var iwContent = '<div style="padding:5px;">경기도 광주시 예방접종센터 <br><a href="https://map.kakao.com/link/map/경기도 광주시 예방접종센터,37.39477923848797, 127.25865020216514" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/Hello World!,37.39477923848797, 127.25865020216514" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
